...
### Скільки гострих кутів має будь-який трикутник?

**Принаймні два.**

Тупий або прямий кут може бути лише один — на два таких уже не вистачить $180°$.
Отже решта два кути завжди гострі.

### Чи може трикутник бути різностороннім і прямокутним водночас?

**Так.** Наприклад, $3$–$4$–$5$: усі сторони різні, а кут між 3 і 4 прямий.

### Чи може трикутник бути рівностороннім і тупокутним?

**Ні.**

У рівностороннього всі кути по $60°$ — тупому взятися нізвідки.

### Периметр рівностороннього трикутника 21. Знайди сторону.

$$21 : 3 = 7$$

### Трикутник зі сторонами 3, 4, 5 — який він за сторонами і за кутами?

За сторонами — **різносторонній** (усі різні).

За кутами — **прямокутний**: $3^2 + 4^2 = 5^2$.

Це два різні поділи, і трикутник має назву в кожному.

### Чи може катет бути довшим за гіпотенузу?

**Ні, ніколи.**

Гіпотенуза лежить проти прямого кута — найбільшого в трикутнику. Проти
